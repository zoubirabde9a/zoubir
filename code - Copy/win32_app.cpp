...
Win32InitWorkQueue(platform_work_queue *Queue, u32 ThreadCount)
{
    Queue->SemaphoreHandle =
        CreateSemaphoreEx(0, 0, ThreadCount,
        ...
        int showCode)
{
    ...
    soundOutput.safetyBytes =
        (soundOutput.samplesPerSecond *
         soundOutput.bytesPerSample / appUpdateHz) / 3;
    soundOutput.tSine = 0;
    ...
    appMemory.PermanentStorageSize = Megabytes(8);
    ...
    appMemory.PlatformAddWorkEntry = PlatformAddWorkEntry;
